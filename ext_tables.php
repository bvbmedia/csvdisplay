...
$tempColumns = Array (
	...
	"tx_csvdisplay_layout" => Array (
		"exclude" => 1,
		"label" => "LLL:EXT:csvdisplay/locallang_db.xml:tt_content.tx_csvdisplay_layout",
		"config" => Array (
			"type" => "input",
			"size" => "20",
	...
	"tx_csvdisplay_delimiter" => Array (
		"exclude" => 1,
		"label" => "LLL:EXT:csvdisplay/locallang_db.xml:tt_content.tx_csvdisplay_delimiter",
		"config" => Array (
			"type" => "input",
			"size" => "1",
		)
