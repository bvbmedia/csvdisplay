...
$tempColumns=Array(
	...
	"tx_csvdisplay_firstdatarow"=>Array(
		...
		"config"=>Array(
			...
			"items"=>Array(
				Array(
					"LLL:EXT:csvdisplay/locallang_db.xml:tt_content.tx_csvdisplay_firstdatarow.I.0",
					"0"
				),
				Array(
					"LLL:EXT:csvdisplay/locallang_db.xml:tt_content.tx_csvdisplay_firstdatarow.I.1",
					"1"
				),
				Array(
					"LLL:EXT:csvdisplay/locallang_db.xml:tt_content.tx_csvdisplay_firstdatarow.I.2",
					"2"
				),
			),
			"size"=>1,
